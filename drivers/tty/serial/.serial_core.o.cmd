...
$(deps_drivers/tty/serial/serial_core.o):
#SYMVER uart_write_wakeup 0xbdd7ed4d
#SYMVER uart_update_timeout 0xa1a4d484
#SYMVER uart_get_baud_rate 0x5f591a17
#SYMVER uart_get_divisor 0xe692f3a2
#SYMVER uart_xchar_out 0x1d7529b9
#SYMVER uart_console_write 0x1048f6e7
#SYMVER uart_parse_earlycon 0xc5a5c678
#SYMVER uart_parse_options 0x4f72a987
#SYMVER uart_set_options 0x4421ad72
#SYMVER uart_suspend_port 0x36bb291e
#SYMVER uart_resume_port 0x463d3b88
#SYMVER uart_register_driver 0xf8f920d7
#SYMVER uart_unregister_driver 0x680fe9b0
#SYMVER uart_console_device 0x8944ceab
#SYMVER uart_match_port 0x4bfd2edb
#SYMVER uart_handle_dcd_change 0x722ef8a7
#SYMVER uart_handle_cts_change 0x866e47d0
#SYMVER uart_insert_char 0xa074cb0d
#SYMVER uart_try_toggle_sysrq 0x062189ef
#SYMVER uart_get_rs485_mode 0x4b5bdf4e
