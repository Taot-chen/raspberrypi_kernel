...
$(deps_drivers/mmc/core/core.o):
#SYMVER mmc_command_done 0x3026f459
#SYMVER mmc_request_done 0xd59dde0e
#SYMVER mmc_start_request 0x954bccdd
#SYMVER mmc_wait_for_req_done 0x9e08fd31
#SYMVER mmc_cqe_start_req 0x4c22dffe
#SYMVER mmc_cqe_request_done 0x3351d63e
#SYMVER mmc_cqe_post_req 0x259c1263
#SYMVER mmc_cqe_recovery 0xef631ab9
#SYMVER mmc_is_req_done 0xe1b49ee4
#SYMVER mmc_wait_for_req 0x84145e54
#SYMVER mmc_wait_for_cmd 0x4f0bccaa
#SYMVER mmc_set_data_timeout 0x6c755813
#SYMVER __mmc_claim_host 0x51987246
#SYMVER mmc_release_host 0x6aca992d
#SYMVER mmc_get_card 0x5752d3f9
#SYMVER mmc_put_card 0x0e7e9c3b
#SYMVER mmc_detect_change 0xe401a245
#SYMVER mmc_erase 0x06f1176f
#SYMVER mmc_can_erase 0xf7ff9993
#SYMVER mmc_can_trim 0x98e158a3
#SYMVER mmc_can_discard 0x0309496c
#SYMVER mmc_can_secure_erase_trim 0xf171cc2e
#SYMVER mmc_erase_group_aligned 0xbbca5539
#SYMVER mmc_calc_max_discard 0x210ab75c
#SYMVER mmc_card_is_blockaddr 0x38095fa9
#SYMVER mmc_set_blocklen 0x94e19392
#SYMVER mmc_hw_reset 0x0fa3afa7
#SYMVER mmc_sw_reset 0x28416e46
#SYMVER mmc_detect_card_removed 0xcf6942e4
#SYMVER mmc_card_alternative_gpt_sector 0xf1bc060b
