...
$(deps_net/socket.o):
#SYMVER sock_alloc_file 0x6ddcfefd
#SYMVER sock_from_file 0x1a961687
#SYMVER sockfd_lookup 0xcd8673c2
#SYMVER sock_alloc 0xf596a5da
#SYMVER sock_release 0x54dcd4cd
#SYMVER __sock_tx_timestamp 0x437a0d6d
#SYMVER sock_sendmsg 0x00dbeda9
#SYMVER kernel_sendmsg 0x83fde93f
#SYMVER kernel_sendmsg_locked 0x19dda195
#SYMVER __sock_recv_timestamp 0x676115ba
#SYMVER __sock_recv_wifi_status 0x05c8afc8
#SYMVER __sock_recv_cmsgs 0x4d436511
#SYMVER sock_recvmsg 0xee6216db
#SYMVER kernel_recvmsg 0x5d4d7cc1
#SYMVER brioctl_set 0xe48320c6
#SYMVER vlan_ioctl_set 0xc5480d93
#SYMVER sock_create_lite 0xd40703b4
#SYMVER sock_wake_async 0x3bf02fb5
#SYMVER __sock_create 0xa3a3b686
#SYMVER sock_create 0x4807abf4
#SYMVER sock_create_kern 0xe235032c
#SYMVER do_sock_setsockopt 0x4a5f58e4
#SYMVER do_sock_getsockopt 0xc76efde5
#SYMVER sock_register 0x037d6c37
#SYMVER sock_unregister 0x62737e1d
#SYMVER get_user_ifreq 0x80816f26
#SYMVER put_user_ifreq 0x87809aeb
#SYMVER kernel_bind 0xc03dda97
#SYMVER kernel_listen 0x486fe69c
#SYMVER kernel_accept 0x0010b131
#SYMVER kernel_connect 0xa100aff1
#SYMVER kernel_getsockname 0x4b2f285b
#SYMVER kernel_getpeername 0xf2d819fb
#SYMVER kernel_sock_shutdown 0x621cf35f
#SYMVER kernel_sock_ip_overhead 0xb58a106b
