...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0xa95bca4b
#SYMVER sk_capable 0xa2dbb44c
#SYMVER sk_net_capable 0x3b2f57c7
...
#SYMVER sk_set_memalloc 0x026b6e13
#SYMVER sk_clear_memalloc 0x46e5160a
#SYMVER __sk_backlog_rcv 0x381264a3
#SYMVER sk_error_report 0xcfdc31b8
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0xa4231a82
#SYMVER sock_queue_rcv_skb_reason 0x669299fd
#SYMVER __sk_receive_skb 0xfdc35e65
#SYMVER __sk_dst_check 0xe6dd4f6d
#SYMVER sk_dst_check 0xd58b6fa6
#SYMVER sock_bindtoindex 0x1764fd7d
#SYMVER sk_mc_loop 0xa427bbb2
#SYMVER sock_set_reuseaddr 0x94f80e52
#SYMVER sock_set_reuseport 0xeb39773c
#SYMVER sock_no_linger 0x9a8bc48b
#SYMVER sock_set_priority 0x8bd13ee9
#SYMVER sock_set_sndtimeo 0x69d5ff89
#SYMVER sock_enable_timestamps 0xd77813ba
#SYMVER sock_set_keepalive 0xf09a41d4
#SYMVER sock_set_rcvbuf 0xf104ad3c
#SYMVER sock_set_mark 0xf29e4b85
#SYMVER sockopt_lock_sock 0xe55cf583
#SYMVER sockopt_release_sock 0xecddbd16
#SYMVER sockopt_ns_capable 0xfba942e4
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0x611bf81a
#SYMVER sk_alloc 0xb8493a70
#SYMVER sk_free 0x3ff0c057
#SYMVER sk_clone_lock 0x81fcf56f
#SYMVER sk_free_unlock_clone 0x1bca7aa8
#SYMVER sk_setup_caps 0x1aed8c07
#SYMVER sock_wfree 0xc9aef5af
#SYMVER skb_set_owner_w 0x61b1e5aa
#SYMVER skb_orphan_partial 0x1a4cb7b4
#SYMVER sock_rfree 0xb1b933f3
#SYMVER sock_efree 0xa29a6ef6
#SYMVER sock_pfree 0x81b0b02b
#SYMVER sock_i_uid 0x8ac7dd0b
#SYMVER __sock_i_ino 0x9e3d108b
#SYMVER sock_i_ino 0x1e3eea92
#SYMVER sock_wmalloc 0xf49e243f
#SYMVER sock_kmalloc 0x1410fa17
#SYMVER sock_kfree_s 0x789f76ea
#SYMVER sock_kzfree_s 0x45592a35
#SYMVER sock_alloc_send_pskb 0xfbd58fc2
#SYMVER __sock_cmsg_send 0x15a49100
#SYMVER sock_cmsg_send 0x599b254c
#SYMVER skb_page_frag_refill 0x80fd4d49
#SYMVER sk_page_frag_refill 0xc45cdda1
#SYMVER __sk_flush_backlog 0x61176691
#SYMVER sk_wait_data 0x65ef2c06
#SYMVER __sk_mem_schedule 0x4b74d566
#SYMVER __sk_mem_reclaim 0x30a2cf2f
#SYMVER sk_set_peek_off 0x572cff7d
#SYMVER sock_no_bind 0xaa3e3f32
#SYMVER sock_no_connect 0x5c2dbb82
#SYMVER sock_no_socketpair 0xefd8cd1f
#SYMVER sock_no_accept 0xae90de4b
#SYMVER sock_no_getname 0x7bb39ee7
#SYMVER sock_no_ioctl 0xda40ab0d
#SYMVER sock_no_listen 0x8feb2657
#SYMVER sock_no_shutdown 0x8208cf73
#SYMVER sock_no_sendmsg 0xfe82f996
#SYMVER sock_no_sendmsg_locked 0xcb78c1cf
#SYMVER sock_no_recvmsg 0x8141f9a9
#SYMVER sock_no_mmap 0xe158ce4b
#SYMVER sk_send_sigurg 0x379c4c27
#SYMVER sk_reset_timer 0x979af241
#SYMVER sk_stop_timer 0x23a700d7
#SYMVER sk_stop_timer_sync 0xbd612d87
#SYMVER sock_init_data_uid 0x4e2cd4ba
#SYMVER sock_init_data 0xb7648cc2
#SYMVER lock_sock_nested 0x613ad860
#SYMVER release_sock 0xd89efcca
#SYMVER __lock_sock_fast 0x1d9de36c
#SYMVER sock_gettstamp 0x1be4c000
#SYMVER sock_recv_errqueue 0x58bc5b82
#SYMVER sock_common_getsockopt 0x01a5570f
#SYMVER sock_common_recvmsg 0x1939116f
#SYMVER sock_common_setsockopt 0x4144d7e8
#SYMVER sk_common_release 0x22bfa033
#SYMVER sock_prot_inuse_get 0x8ffccc22
#SYMVER sock_inuse_get 0xfa28ecf7
#SYMVER proto_register 0x94ce64cf
#SYMVER proto_unregister 0x10ce5392
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0x4db43a1e
#SYMVER sock_ioctl_inout 0xafb3e4c7
#SYMVER sk_ioctl 0x845f2136
