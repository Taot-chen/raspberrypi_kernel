...
$(deps_mm/filemap.o):
#SYMVER filemap_check_errors 0xbc7d4648
#SYMVER filemap_fdatawrite_wbc 0x704c0a9a
#SYMVER filemap_fdatawrite 0x1f3a7361
#SYMVER filemap_fdatawrite_range 0x5c30cc59
#SYMVER filemap_flush 0xda34abb2
#SYMVER filemap_range_has_page 0x70347fab
#SYMVER filemap_fdatawait_range 0xe8c85085
#SYMVER filemap_fdatawait_range_keep_errors 0x42036992
#SYMVER file_fdatawait_range 0x9b64c750
#SYMVER filemap_fdatawait_keep_errors 0x99d00e75
#SYMVER filemap_range_has_writeback 0x16a52eaf
#SYMVER filemap_write_and_wait_range 0xf7859858
#SYMVER __filemap_set_wb_err 0xc9036648
#SYMVER file_check_and_advance_wb_err 0x14967a21
#SYMVER file_write_and_wait_range 0x6b093ed0
#SYMVER replace_page_cache_folio 0x818dad05
#SYMVER filemap_add_folio 0xaebc72ef
#SYMVER filemap_alloc_folio 0xe4dd849c
#SYMVER filemap_invalidate_lock_two 0x51383934
#SYMVER filemap_invalidate_unlock_two 0x2e413d71
#SYMVER folio_wait_bit 0x2fbf1a2b
#SYMVER folio_wait_bit_killable 0x96c82dc6
#SYMVER folio_add_wait_queue 0x0a501a30
#SYMVER folio_unlock 0x24830a2a
#SYMVER folio_end_private_2 0x998e1ef8
#SYMVER folio_wait_private_2 0x8c2ce4d5
#SYMVER folio_wait_private_2_killable 0x3ed65ac7
#SYMVER folio_end_writeback 0x6f5743a7
#SYMVER __folio_lock 0xca4a49c9
#SYMVER __folio_lock_killable 0x18e90c2d
#SYMVER page_cache_next_miss 0xa52918c1
#SYMVER page_cache_prev_miss 0xba4cfcd5
#SYMVER __filemap_get_folio 0x3e9e8fd8
#SYMVER filemap_get_folios 0xbaf5e376
#SYMVER filemap_get_folios_contig 0x8fc12c50
#SYMVER filemap_get_folios_tag 0x47409369
#SYMVER filemap_read 0xcbc68787
#SYMVER generic_file_read_iter 0x6408d5b5
#SYMVER filemap_splice_read 0x905005e2
#SYMVER filemap_fault 0xd8d95cd5
#SYMVER filemap_map_pages 0xe6cbc698
#SYMVER filemap_page_mkwrite 0x80b0c619
#SYMVER generic_file_mmap 0xcd141f25
#SYMVER generic_file_readonly_mmap 0x0a852580
#SYMVER read_cache_folio 0xef55215e
#SYMVER mapping_read_folio_gfp 0xa31e99e6
#SYMVER read_cache_page 0xd0a6dc89
#SYMVER read_cache_page_gfp 0xcf63dac2
#SYMVER generic_file_direct_write 0xa0cfa1f5
#SYMVER generic_perform_write 0x90a64d46
#SYMVER __generic_file_write_iter 0xde59fec0
#SYMVER generic_file_write_iter 0x243071cd
#SYMVER filemap_release_folio 0x8bfcfb82
