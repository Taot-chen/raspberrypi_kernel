...
$(deps_fs/locks.o):
#SYMVER locks_alloc_lock 0x03945cc3
#SYMVER locks_release_private 0x434f92db
#SYMVER locks_owner_has_blockers 0x45a25ee5
#SYMVER locks_free_lock 0x31fa94a3
#SYMVER locks_init_lock 0x76953c11
#SYMVER locks_copy_conflock 0x6f756b44
#SYMVER locks_copy_lock 0xfdc060ee
#SYMVER locks_delete_block 0x6ac75faa
#SYMVER posix_test_lock 0x9ce8c6ec
#SYMVER posix_lock_file 0x62517fea
#SYMVER lease_modify 0xeacfecd8
#SYMVER __break_lease 0x96528bcb
#SYMVER lease_get_mtime 0x05002460
#SYMVER generic_setlease 0x698840d0
#SYMVER lease_register_notifier 0x43aa319e
#SYMVER lease_unregister_notifier 0x985453e1
#SYMVER vfs_setlease 0x01dd80b1
#SYMVER locks_lock_inode_wait 0xdb52b56f
#SYMVER vfs_test_lock 0x82e37a36
#SYMVER vfs_lock_file 0xdd92b0f0
#SYMVER locks_remove_posix 0x85883d08
#SYMVER vfs_cancel_lock 0x8f65f66b
#SYMVER vfs_inode_has_locks 0x07a93b13
