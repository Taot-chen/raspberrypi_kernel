...
$(deps_block/blk-mq.o):
#SYMVER blk_freeze_queue_start 0xa03372db
#SYMVER blk_mq_freeze_queue_wait 0x38831cb0
#SYMVER blk_mq_freeze_queue_wait_timeout 0x4970aac2
#SYMVER blk_mq_freeze_queue 0xc9e4d613
#SYMVER blk_mq_unfreeze_queue 0x31d02729
#SYMVER blk_mq_quiesce_queue_nowait 0xf40541f5
#SYMVER blk_mq_wait_quiesce_done 0x0bd40132
#SYMVER blk_mq_quiesce_queue 0x23661712
#SYMVER blk_mq_unquiesce_queue 0xe592fa51
#SYMVER blk_mq_quiesce_tagset 0xf2b5e2c3
#SYMVER blk_mq_unquiesce_tagset 0xf75aa634
#SYMVER blk_rq_init 0x4f33cc88
#SYMVER blk_mq_alloc_request 0x2000978b
#SYMVER blk_mq_alloc_request_hctx 0x4c50f0fc
#SYMVER blk_mq_free_request 0x447f3472
#SYMVER blk_dump_rq_flags 0xfe91b028
#SYMVER blk_update_request 0x3c2050f6
#SYMVER __blk_mq_end_request 0x3e4abbe2
#SYMVER blk_mq_end_request 0xf76cb008
#SYMVER blk_mq_end_request_batch 0xe5e787d1
#SYMVER blk_mq_complete_request_remote 0xb1d575f0
#SYMVER blk_mq_complete_request 0xb73e4b50
#SYMVER blk_mq_start_request 0x2a637222
#SYMVER blk_execute_rq_nowait 0xc73ca0a3
#SYMVER blk_rq_is_poll 0x7fd6f17c
#SYMVER blk_execute_rq 0x872624a4
#SYMVER blk_mq_requeue_request 0x3c430173
#SYMVER blk_mq_kick_requeue_list 0xf53a8c75
#SYMVER blk_mq_delay_kick_requeue_list 0x2531d33f
#SYMVER blk_mq_queue_inflight 0xa665a540
#SYMVER blk_mq_flush_busy_ctxs 0x7201c164
#SYMVER blk_mq_delay_run_hw_queue 0x1fba3577
#SYMVER blk_mq_run_hw_queue 0x884e57f0
#SYMVER blk_mq_run_hw_queues 0xa37f9810
#SYMVER blk_mq_delay_run_hw_queues 0x73eab0a2
#SYMVER blk_mq_stop_hw_queue 0x8a3fa477
#SYMVER blk_mq_stop_hw_queues 0x82e25eb0
#SYMVER blk_mq_start_hw_queue 0x26d67669
#SYMVER blk_mq_start_hw_queues 0x78418a01
#SYMVER blk_mq_start_stopped_hw_queue 0x6bf67213
#SYMVER blk_mq_start_stopped_hw_queues 0x9a9f93f7
#SYMVER blk_insert_cloned_request 0xe06ea57a
#SYMVER blk_rq_unprep_clone 0xe6ba7455
#SYMVER blk_rq_prep_clone 0xb92f92f1
#SYMVER blk_steal_bios 0xd09c6ae8
#SYMVER blk_mq_init_queue 0x7a4bc531
#SYMVER blk_mq_destroy_queue 0x1e999c9e
#SYMVER __blk_mq_alloc_disk 0x43bc010b
#SYMVER blk_mq_alloc_disk_for_queue 0x0e19ce90
#SYMVER blk_mq_init_allocated_queue 0xf4b08657
#SYMVER blk_mq_alloc_tag_set 0xd2432307
#SYMVER blk_mq_alloc_sq_tag_set 0x348f74a8
#SYMVER blk_mq_free_tag_set 0x749c708c
#SYMVER blk_mq_update_nr_hw_queues 0x527aaea8
#SYMVER blk_rq_poll 0x4bb1024b
#SYMVER blk_mq_rq_cpu 0x3350784b
